...
if($_REQUEST[method]=="1"){
	...
	if(mysqli_num_rows($result2)>0) {
		...
		$sql = "UPDATE fs_stock SET Stock_Status = '4',Stock_OutDate = '".date("Y-m-d")."'  Where Stock_Code = '$_REQUEST[barcode]' ";
		...
		if($_GET[barcode]!=""){
			header("location: list_scan_out_select.php");
		}
						...
						<div class="row">
                            <div class="col-md-12">
								...
								<div class="portlet light bordered">
									...
									<form id="myForm" name="myForm" method="post" action="list_scan_out_select.php" target="zxcv" onSubmit="DelayedSubmission()">
													...
													<table class="table table-striped table-bordered table-hover" id="sample_1">
														...
														<tbody>
															...
															<tr class="_barcode_<?=$row[Stock_Code]?>">
																...
																<td><a href="list_scan_out_select.php?barcode=<?=$row[Stock_Code]?>&method=1" class="btn btn-circle btn-xs blue-chambray"><i class="glyphicon glyphicon-pencil"></i> Scan Out </a></td>
															</tr>
															<?php
																$i++;}}
															?>
