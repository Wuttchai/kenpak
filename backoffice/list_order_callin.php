                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
											...
											<a href="add_customer.php" class="btn btn-circle green-jungle btn-sm"><span class="glyphicon glyphicon-plus"></span> Add Customer </a> 
									...
									<input type="hidden" name="page" value="1">
										...
										<?php
											...
											$sql .= " AND Customer_Status = '1' ORDER BY Customer_Code ASC LIMIT $goto,$page_rows";
											$result = mysqli_query($conn, $sql);
											...
											<table class="table table-striped table-bordered table-hover">
												...
												?>
													<tr>
														...
														<td>
															<a href="edit_customer.php?id=<?=$row[Customer_Id]?>" class="btn btn-circle btn-xs blue"><i class="icon-basket"></i> Order </a>
														</td>
													</tr>
												<?php
														$i++;
