...
if($_POST[method]=="1"){
	...
	if($rowcount==0 OR $_POST[Old_Code]==$_POST[Unit_Code]){
		$sql = "INSERT INTO fs_unit (Unit_Code, Unit_ThName, Unit_EnName) 
				VALUES ('$_POST[Unit_Code]', '$_POST[Unit_ThName]', '$_POST[Unit_EnName]')";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <form role="form" action="add_unit.php" method="post">
										<input type="hidden" name="method" value="1">
										<input type="hidden" name="Unit_Id" value="<?=$row[Unit_Id]?>">
										<input type="hidden" name="Old_Code" value="<?=$row[Unit_Code]?>">
											<div class="form-group">
												<label>Unit Code</label>
												<input type="text" class="form-control input-sm" maxlength="3" name="Unit_Code">
											</div>
											<div class="form-group">
												<label>Thai Unit Name</label>
												<input type="text" class="form-control input-sm" name="Unit_ThName">
											</div>
											<div class="form-group">
												<label>English Unit  Name</label>
												<input type="text" class="form-control input-sm" name="Unit_EnName">
											</div>
