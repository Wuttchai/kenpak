                                ...
                                <div class="portlet light bordered">
									...
									<div class="tabbable tabbable-tabdrop">
                                            <ul class="nav nav-tabs">
                                                <li>
                                                    <a href="#tab1" data-toggle="tab">รายการสินค้าเตรียมเข้าคลัง</a>
                                                </li>
                                                <li class="active">
                                                    <a href="#tab2" data-toggle="tab">รายการสินค้าในคลัง</a>
                                                </li>
                                                <li>
                                                    <a href="#tab3" data-toggle="tab">รายการสินค้าออกจากคลัง</a>
                                                </li>
                                                <li>
                                                    <a href="#tab4" data-toggle="tab">รายการสินค้าทั้งหมด</a>
                                                </li>
                                            </ul>
														...
														<?php
															...
															if($_GET[text]!=""){
																$sql .= " AND (fs_stock.Stock_Code like '%$_GET[text]%' 
																		...
																		OR fs_stock.Stock_ExpDate like '%$_GET[text]%')";
																}
															...
															<table class="table table-striped table-bordered table-hover">
																...
																?>
																	<tr>
																		...
																		<td> <?=$row[Stock_CreateDate]?> </td>
																		<td> <?php if(date("Y-m-d")>=($row[Stock_ExpDate])){echo '<font color="red">'.$row[Stock_ExpDate].'</font>';}else{echo '<font color="green">'.$row[Stock_ExpDate].'</font>';} ?> </td>
																		<td> <?=$row[Rack_Code]?> </td>
																		<td> <?=$text_Stock?> </td>
																		<td>
																			<a href="print_barcodestock.php?id=<?=$row[Stock_Code]?>" class="btn btn-circle btn-xs blue" target="_blank"> Print Barcode </a>
															...
															<table class="table table-striped table-bordered table-hover">
																...
																?>
																	<tr>
																		...
																		<td>
																			<a href="print_barcodestock.php?id=<?=$row[Stock_Code]?>" class="btn btn-circle btn-xs blue" target="_blank"> Print Barcode </a> 
																			<a href="add_scrap.php?id=<?=$row[Stock_Code]?>" class="btn btn-circle btn-xs red-flamingo"> Scrap </a>
																		</td>
																	</tr>
																<?php
																		}
