                                ...
                                <div class="portlet light bordered">
									...
									<input type="hidden" name="page" value="1">
										...
										<?php
											...
											$sql .= " AND Market_Status = '1' ORDER BY Market_Code ASC LIMIT $goto,$page_rows";
											$result = mysqli_query($conn, $sql);
											...
											<table class="table table-striped table-bordered table-hover">
												...
												?>
													<tr>
														...
														<td> <?=$row[Market_Name]?> </td>
														<td>
															<a href="edit_marketarea.php?id=<?=$row[Market_Id]?>" class="btn btn-circle btn-xs blue"><i class="glyphicon glyphicon-pencil"></i> Edit </a>
														</td>
													</tr>
												<?php
														}
