...
if($_POST[method]=="1"){
	...
	$result = mysqli_query($conn, $sql);
		if(mysqli_num_rows($result) > 0) {
			...
			header("location: index.php?msg=2&cty=1");
		}
	}
        ...
        <div class="content">
			...
			<input type="hidden" name="method" value="1">
				...
				<div class="form-group">
					...
					<select class="form-control form-control-solid" name="usertype" required>
					  <option value="">เลือกประเภท</option>
					  <option value="employer" <?php if($_GET[cty]=="1"){echo "selected";}?>>เจ้าหน้าที่</option>
					  <!--<option value="customer" <?php if($_GET[cty]=="2"){echo "selected";}?>>ลูกค้า</option>-->
					  <option value="supplier" <?php if($_GET[cty]=="3"){echo "selected";}?>>ซัพพลายเออร์</option>
					</select>
				</div>
