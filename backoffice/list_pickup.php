...
if($_REQUEST[method]=="1"){
	...
	if(mysqli_num_rows($result2)>0) {
		...
		$sql = "UPDATE fs_orders_detail SET Ordersde_Flag = '2' Where Ordersde_Barcode = '$_REQUEST[barcode]' ";
		...
		$sql2 = "SELECT * FROM fs_orders_detail 
				...
				AND fs_orders_detail.Ordersde_Flag = '1'";
		$result2 = mysqli_query($conn, $sql2);
						...
						<div class="row">
                            <div class="col-md-12">
								...
								<div class="portlet light bordered">
									...
									<form id="myForm" name="myForm" method="post" action="list_pickup.php?ddate=<?=$_GET[ddate]?>" target="zxcv" onSubmit="DelayedSubmission()">
									<input type="hidden" name="method" id="method" value="1">
									<div class="row">
										<div class="col-md-2">Date Barcode : <?=$_GET[ddate]?></div>
