...
if($_POST[method]=="1"){
	...
	if($rowcount==0 OR $_POST[Old_Code]==$_POST[Rack_Code]){
		$sql = "UPDATE fs_rack SET 
				Rack_Code = '$_POST[Rack_Code]',  
				Rack_Detail = '$_POST[Rack_Detail]' 
				WHERE Rack_Id like '$_POST[Rack_Id]'";
...
$sql = "SELECT * FROM fs_rack WHERE Rack_Id = '$_GET[id]'";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
										...
										<input type="hidden" name="Rack_Id" value="<?=$row[Rack_Id]?>">
										<input type="hidden" name="Old_Code" value="<?=$row[Rack_Code]?>">
											<div class="form-group">
												<label>Rack Code</label>
												<input type="text" class="form-control input-sm" name="Rack_Code" id="Rack_Code" value="<?=$row[Rack_Code]?>" required>
											</div>
											<div class="form-group">
												<label>Rack Detail</label>
												<input type="text" class="form-control input-sm" name="Rack_Detail" id="Rack_Detail" value="<?=$row[Rack_Detail]?>" required>
											</div>
