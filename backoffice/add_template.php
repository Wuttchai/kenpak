...
if($_POST[method]=="1"){
	$sql = "INSERT INTO fs_template (Template_Name, Template_Detail, Template_Status, Customer_Id, Template_CreateBy) 
			VALUES ('$_POST[Template_Name]', '$_POST[Template_Detail]', '$_POST[Template_Status]', '$_POST[Customer_Id]', 'customer')";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
										...
										<input type="hidden" name="Customer_Id" value="<?=$_SESSION[user_id]?>" required>
