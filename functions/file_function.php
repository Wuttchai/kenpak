...
function upload_file($file_name, $target_dir, $file_size, $file_type){
	...
	if($file_type=="images,document"){
		if($imageFileType != "jpg" AND $imageFileType != "png" AND $imageFileType != "jpeg" AND $imageFileType != "gif" AND $imageFileType != "pdf" AND $imageFileType != "doc" AND $imageFileType != "docx") {
