...
$sql = "SELECT * FROM fs_sell_product LEFT JOIN fs_product ON fs_sell_product.Product_Code = fs_product.Product_Code ";
if($_GET[text]!=""){
	$sql .= "WHERE fs_sell_product.SellProduct_ThName like '%$_GET[text]%' ";
}
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="container">
							...
							<div class="col-lg-12">
								<form action="search.php" method="get">
									<div class="input-group">
										...
										<input type="text" class="typeahead form-control control-search" name="text" value="<?=$_GET[text];?>" required autocomplete="off" >
						...
						<div class="row">
							<div class="col-lg-12">
								<p style="margin-top: 1em;">พบสินค้าจำนวน <?=$numrows;?> รายการ 
								<?php if($numrows<1){ ?>
									(0/<?=maximun_page($numrows, $page_rows);?> หน้า)</p>
								<?php }else{ ?>
									(<?=$_GET[page];?>/<?=maximun_page($numrows, $page_rows);?> หน้า)</p>
								<?php } ?>
							</div>
						</div>
						<hr>
							...
							<div class="tab-container space-10">
								<div class="row">
									<?php
										...
										if($_GET[text]!=""){
											$sql_1 .= "WHERE fs_sell_product.SellProduct_ThName like '%$_GET[text]%' ";
										}
											$sql_1 .= " LIMIT 0,15";
						...
						<center>
							<?php 
							pagination_number(maximun_page($numrows, $page_rows), $_GET[page], "search.php?text=".$_GET[text], 3); ?>
						</center>
					</div>
                </div>
                <!--End col-md-9-->
